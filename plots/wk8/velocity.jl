...
srhmc = RelHMCState(zeros(2),stepsize=0.01,c=9.0, mass=0.4);
...
title("histogram of velocity, stepsize=0.01")
legend()

h5open("mydata.h5", "w") do file
    write(file, "velocity", vhmc,"rvelocity", rvhmc, "stepsize", stepsize)  # alternatively, say "@write file A"
end
